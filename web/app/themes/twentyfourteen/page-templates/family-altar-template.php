                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <img src="<?= get_template_directory_uri(); ?>/assets/img/testimony/Dave.png"
                                    alt="reviewer image"
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-[16px] text-etGray font-normal mb-[20px] sm:text-[12px]">Salah satu
                                karakterku yang bertumbuh yaitu "Kasih", jadi lebih mengerti dan bisa mengasihi sesama
                                daripada sebelum gabung berkomunitas FA BPro.
                            </p>
                        </div>
                ...
                <div class="swiper-slide">
                    <div
                        ...
                        <div
                            ...
                            <div
                                class="et-testimony__img rounded-full overflow-hidden border border-etBlue p-[7px] w-max max-w-full">
                                <img src="<?= get_template_directory_uri(); ?>/assets/img/testimony/Nelfin.png"
                                    alt="reviewer image"
                                    class="w-[100px] sm:w-[80px] h-[100px] sm:h-[80px] rounded-full">
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-[16px] text-etGray font-normal mb-[20px] sm:text-[12px]">Di FA BPro, aku
                                belajar karakter sabar dan legowo, artinya mau menerima sesama saudara kita apa adanya.
                                Dan disana kita belajar saling support dan bertumbuh bersama.</p>
                        </div>
                ...
                <div class="swiper-slide">
                    <div
                        ...
                        <div
                            ...
                            <div
                                class="et-testimony__img rounded-full overflow-hidden border border-etBlue p-[7px] w-max max-w-full">
                                <img src="<?= get_template_directory_uri(); ?>/assets/img/testimony/Yohan.png"
                                    alt="reviewer image"
                                    class="w-[100px] sm:w-[80px] h-[100px] sm:h-[80px] rounded-full">
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-[16px] text-etGray font-normal mb-[20px] sm:text-[12px]">Bisa sharing semua
                                hal, ga melulu masalah kerohanian, tapi juga cerita pribadi. Terus juga bisa berbagi
                                suka dan duka. Itulah kenapa aku harus ikut FA BPro.</p>
                        </div>
                ...
                <div class="swiper-slide">
                    <div
                        ...
                        <div
                            ...
                            <div
                                class="et-testimony__img rounded-full overflow-hidden border border-etBlue p-[7px] w-max max-w-full">
                                <img src="<?= get_template_directory_uri(); ?>/assets/img/testimony/Neni.png"
                                    alt="reviewer image"
                                    class="w-[100px] sm:w-[80px] h-[100px] sm:h-[80px] rounded-full">
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-[16px] text-etGray font-normal mb-[20px] sm:text-[12px]">Aku ikut FA BPro
                                karena ingin punya komunitas yang lebih kecil, agar lebih dekat dengan teman, bisa
                                sharing, bisa latihan nyanyi bareng juga.</p>
                        </div>
