                ...
                <div
                    ...
                    <button data-tab="et-event-tab4"
                        class="sm:hidden tab-nav border-r border-[#d9d9d9] text-[14px] font-medium text-etBlack pr-[45px] pl-[10px] md:pr-[30px] xxs:pr-[20px] hover:text-etBlue group"><span
                            class=" group-[.active]:text-etBlue">SBY Selatan</span>
                    </button>
                    <button data-tab="et-event-tab4"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="et-schedule-loaction flex items-center gap-[12px]">
                                ...
                                <h6 class="text-[15px] text-etGray sm:text-[16px] sm:my-[10px]">Jl. Ngagel Madya Utara,
                                    Surabaya</h6>
                            </div>
                            <div class="et-schedule-loaction flex items-center gap-[12px]">
                                <span class="icon">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="et-schedule-loaction flex items-center gap-[12px]">
                                ...
                                <h6 class="text-[15px] text-etGray sm:text-[16px] sm:my-[10px]">Jl. Nginden Intan Timur,
                                    Surabaya</h6>
                            </div>
                            <div class="et-schedule-loaction flex items-center gap-[12px]">
                                <span class="icon">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="et-schedule-loaction flex items-center gap-[12px]">
                                ...
                                <h6 class="text-[15px] text-etGray sm:text-[16px] sm:my-[10px]">Jl. Wonokitri, Surabaya
                                </h6>
                            </div>
                            <div class="et-schedule-loaction flex items-center gap-[12px]">
                                <span class="icon">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="et-schedule-loaction flex items-center gap-[12px]">
                                ...
                                <h6 class="text-[15px] text-etGray sm:text-[16px] sm:my-[10px]">Jl. Rungkut Menanggal
                                    Harapan, Surabaya</h6>
                            </div>
                            <div class="et-schedule-loaction flex items-center gap-[12px]">
                                <span class="icon">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="et-schedule-loaction flex items-center gap-[12px]">
                                ...
                                <h6 class="text-[15px] text-etGray sm:text-[16px] sm:my-[10px]">Jl. Arif Rahman Hakim,
                                    Surabaya</h6>
                            </div>
                            <div class="et-schedule-loaction flex items-center gap-[12px]">
                                <span class="icon">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="et-schedule-loaction flex items-center gap-[12px]">
                                ...
                                <h6 class="text-[15px] text-etGray sm:text-[16px] sm:my-[10px]">Jl. Puri Safira Regency,
                                    Menganti</h6>
                            </div>
                            <div class="et-schedule-loaction flex items-center gap-[12px]">
                                <span class="icon">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="et-schedule-loaction flex items-center gap-[12px]">
                                ...
                                <h6 class="text-[15px] text-etGray sm:text-[16px] sm:my-[10px]">Jl. Galaxy Bumi Permai,
                                    Surabaya</h6>
                            </div>
                            <div class="et-schedule-loaction flex items-center gap-[12px]">
                                <span class="icon">
