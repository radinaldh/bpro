        ...
        <div class="et-events-slider swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide group">
                    <div class="et-event bg-[url('<?= get_template_directory_uri(); ?>/assets/img/event-bg-big.jpg')] bg-cover bg-no-repeat bg-center relative z-[1] rounded-[20px] overflow-hidden before:content-normal before:absolute before:inset-0 before:bg-gradient-to-b before:from-transparent before:to-black/70 before:-z-[1]">
                            ...
                            <div>
                                ...
                                <div class="et-schedule-date-time border border-[rgba(217,217,217,0.89)] py-[4.5px] px-[15px] rounded-full inline-flex items-center justify-center xxs:flex-wrap gap-x-[24px] gap-y-[10px] mb-[20px] translate-y-[30px] opacity-0 group-[.swiper-slide-active]:translate-y-0 group-[.swiper-slide-active]:opacity-100 transition ease-linear duration-[500ms]">
                                    <div class="date flex items-center gap-[10px]">
                                        ...
                                        <span class="font-light text-[16px]">24, Jan - 2024</span>
                                    </div>
                                </div>

                                <!-- title -->
                                <h3 class="et-schedule-title text-[30px] xxs:text-[25px] font-medium leading-[1.4] max-w-[470px] mb-[8px] translate-y-[30px] opacity-0 group-[.swiper-slide-active]:translate-y-0 group-[.swiper-slide-active]:opacity-100 transition ease-linear duration-[500ms] delay-[500ms]"><a href="event-details.html" class="hover:text-etBlue">Siempre Son Flores" Musica Cubana Salsa Jazz adipi</a></h3>
                                ...
                                <div class="et-schedule-loaction flex items-center gap-[12px] translate-y-[30px] opacity-0 group-[.swiper-slide-active]:translate-y-0 group-[.swiper-slide-active]:opacity-100 transition ease-linear duration-[500ms] delay-[1100ms]">
                                    ...
                                    <h6 class="font-kanit font-normal text-[16px]">135 W, 46nd Street, New York</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide group">
                    <div class="et-event bg-[url('<?= get_template_directory_uri(); ?>/assets/img/event-bg-big-2.jpg')] bg-cover bg-no-repeat bg-center relative z-[1] rounded-[20px] overflow-hidden before:content-normal before:absolute before:inset-0 before:bg-gradient-to-b before:from-transparent before:to-black/70 before:-z-[1]">
                        <div class="txt h-full flex flex-col justify-between items-start gap-[265px] lg:gap-[215px] xxs:gap-[165px] p-[40px] lg:p-[20px] pb-[50px] md:pb-[80px] text-white">
                            <div>
                                <div class="bg-etBlue rounded-full px-[15px] py-[4px]">
                                    <span class="font-light text-[18px]">Upcoming Event</span>
...
<div class="py-[130px] lg:py-[80px] md:py-[60px] overflow-hidden">
    ...
    <section class="et-all-events">
        <div class="container mx-auto max-w-[1200px] px-[12px] xl:max-w-full">
            <div class="flex lg:flex-wrap items-center justify-between lg:justify-center gap-y-[15px] shadow-[0_4px_50px_rgba(0,0,0,0.07)] mb-[60px] rounded-full xxs:rounded-[30px] lg:py-[15px] px-[30px] pr-[6px] md:px-[20px] md:pr-[6px] py-[20px]">
                <div class="et-events-tab-navs w-[50%] lg:w-full flex xs:flex-wrap shrink-0 lg:justify-center gap-[45px] md:gap-[30px] xxs:gap-[20px] md:gap-y-[15px]">
                    <button data-tab="et-event-tab1" class="tab-nav border-r border-[#d9d9d9] text-[18px] font-medium text-etBlack pr-[45px] pl-[10px] md:pr-[30px] xxs:pr-[20px] hover:text-etBlue group active"><span class="group-[.active]:text-etBlue">Worship Schedule</span></button>
                    <button data-tab="et-event-tab2" class="tab-nav border-r border-[#d9d9d9] text-[18px] font-medium text-etBlack pr-[45px] pl-[10px] md:pr-[30px] xxs:pr-[20px] hover:text-etBlue group"><span class="group-[.active]:text-etBlue">Special Event</span></button>
                    <button data-tab="et-event-tab3" class="tab-nav border-r border-[#d9d9d9] text-[18px] font-medium text-etBlack pr-[45px] pl-[10px] md:pr-[30px] xxs:pr-[20px] hover:text-etBlue group><span class=" group-[.active]:text-etBlue">FA Pastors Meeting</span></button>
                    <button data-tab="et-event-tab3" class="tab-nav border-r border-[#d9d9d9] text-[18px] font-medium text-etBlack pr-[45px] pl-[10px] md:pr-[30px] xxs:pr-[20px] hover:text-etBlue group><span class=" group-[.active]:text-etBlue">Joint Prayer</span></button>
                    <button data-tab="et-event-tab3" class="tab-nav border-r border-[#d9d9d9] text-[18px] font-medium text-etBlack pr-[45px] pl-[10px] md:pr-[30px] xxs:pr-[20px] hover:text-etBlue group><span class=" group-[.active]:text-etBlue">BPro FunDay</span></button>
                    <button data-tab="et-event-tab3" class="tab-nav border-r border-[#d9d9d9] text-[18px] font-medium text-etBlack pr-[45px] pl-[10px] md:pr-[30px] xxs:pr-[20px] hover:text-etBlue group><span class=" group-[.active]:text-etBlue">BPro Workshop</span></button>
                    <button data-tab="et-event-tab3" class="tab-nav text-[18px] font-medium text-etBlack hover:text-etBlue group"><span class="group-[.active]:text-etBlue">Citywide Bethany Event</span></button>
                </div>
            </div>

            <div class="et-schedules-tab-container">
                <div id="et-event-tab1" class="et-tab active">
                    <div class="all-scheduled-events space-y-[30px]">
                        ...
                        <div class="et-schedule flex md:flex-wrap gap-x-[30px] gap-y-[20px] justify-between rev-slide-up">
                            <!-- img -->
                            <div class="w-[270px] h-[226px] shadow-[0_4px_60px_rgba(18,96,254,0.12)] shrink-0 rounded-[20px] overflow-hidden"><img src="<?= get_template_directory_uri(); ?>/assets/img/evenet-sched-1.jpg" alt="scehduled-event-cover"></div>
                            ...
                            <div class="px-[37px] sm:px-[22px] py-[30px] shadow-[0_4px_60px_rgba(18,96,254,0.12)] w-full rounded-[20px] flex gap-y-[15px] xs:flex-col items-center xs:items-start">
                                <div class="et-schedule__heading pr-[40px] sm:pr-[25px] xs:pr-0 mr-[40px] sm:mr-[25px] xs:mr-0 border-r xs:border-r-0 border-[#d9d9d9]">
                                    ...
                                    <!-- title -->
                                    <h3 class="et-schedule-title text-[24px] sm:text-[22px] font-regular text-etBlack leading-[1.25] mb-[16px] anim-text"><a href="event-details.html" class="hover:text-etBlue">Siempre Son Flores" Musica Cubana Salsa Jazz adipi scing elit. Nullam</a></h3>
                        ...
                        <div class="et-schedule flex md:flex-wrap gap-x-[30px] gap-y-[20px] justify-between rev-slide-up">
                            <!-- img -->
                            <div class="w-[270px] h-[226px] shadow-[0_4px_60px_rgba(18,96,254,0.12)] shrink-0 rounded-[20px] overflow-hidden"><img src="<?= get_template_directory_uri(); ?>/assets/img/evenet-sched-2.jpg" alt="scehduled-event-cover"></div>
                        ...
                        <div class="et-schedule flex md:flex-wrap gap-x-[30px] gap-y-[20px] justify-between rev-slide-up">
                            <!-- img -->
                            <div class="w-[270px] h-[226px] shadow-[0_4px_60px_rgba(18,96,254,0.12)] shrink-0 rounded-[20px] overflow-hidden"><img src="<?= get_template_directory_uri(); ?>/assets/img/evenet-sched-3.jpg" alt="scehduled-event-cover"></div>
