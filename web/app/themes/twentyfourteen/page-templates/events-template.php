        ...
        <div class="et-events-slider swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide group">
                    <div style="background-image:url('<?= get_template_directory_uri() ?>/assets/new-img/1.png')"
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex shrink-0 flex-col xxs:flex-row gap-[16px] xxs:gap-[10px]">
                                    <!-- <a href="#" class="et-btn border w-[180px] bg-etBlue text-white inline-flex items-center justify-center h-[45px] px-[22px] xxs:px-[16px] font-normal text-[17px] rounded-full hover:!bg-etBlack hover:!text-white">View More</a> -->
                                    <a href="#"
                                        class="et-btn border w-[180px] bg-etBlack text-white inline-flex items-center justify-center h-[45px] px-[22px] xxs:px-[16px] font-normal text-[17px] rounded-full hover:!bg-etBlue hover:!text-white">Cooming
                                        Soon</a>
                                </div>
                            </div>
                        </div>
