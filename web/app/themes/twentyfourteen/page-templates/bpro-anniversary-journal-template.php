...
/**
 * Template Name: BPro Anniversary Journal Template
 */
    ...
    <div class="container mx-auto max-w-[1200px] px-[12px] xl:max-w-full">
        <div class="flex gap-[30px] lg:gap-[20px] md:flex-col md:items-center">
            ...
            <div class="left grow space-y-[40px] md:space-y-[30px]">
                ...
                $args = array(
                    'category_name' => 'BPro Anniversary',
                    'orderby'    => 'date',
                    'post_status' => 'publish',
                    'posts_per_page' => 3,
                    'paged' => $currentPage,
            ...
            <div class="right max-w-full w-[370px] lg:w-[360px] shrink-0 space-y-[30px] md:space-y-[25px]">
                ...
                <div
                    ...
                    <div class="posts mt-[30px] space-y-[24px]">
                        <!-- single post -->
                        <?php $latest = new WP_Query(array('cat' => 6, 'posts_per_page' => 3, 'orderby' => 'title', 'order' => 'ASC')); ?>
