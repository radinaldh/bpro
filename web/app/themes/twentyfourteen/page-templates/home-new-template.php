...
/**
 * Template Name: Home New Design Template
 */
...
<main>
      ...
      <div class="et-banner-slider swiper">
         <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
               ...
               <div
                  class="bg-no-repeat bg-cover bg-[url('assets/img/banner-2-bg-1.jpg')] bg-center pt-[clamp(140px,12.7vw,213px)] text-white relative overflow-hidden z-[1] before:content-normal before:absolute before:inset-0 before:bg-gradient-to-r before:from-[#1900B1] before:from-50% before:to-transparent before:-z-[1] before:opacity-50">

                  <div
                     class="mx-[15.5em] xxxl:mx-[10em] xxl:mx-[40px] xs:mx-[12px] mb-[132px] xl:mb-[112px] lg:mb-[82px]">
                     <div
                  ...
                  <div class="flex gap-[120px] xxxl:gap-[60px] xl:gap-[40px] lg:flex-col-reverse items-center"
                     ...
                     <div
                        ...
                        <div class="pr-[54px] border-r md:border-r-0 border-white/20 md:text-center md:pr-0 md:w-full">
                           <h2 class="text-[35px] sm:text-[24px] !text-white mb-[28px] anim-text">Count Every Second
                              Until Event.</h2>
                           <a href="#"
                        ...
                        <!-- vectors -->
                        <div class="sm:hidden">
                           <img src="<?= get_template_directory_uri(); ?>/assets/img/counter-vector.png" alt="vector"
                  ...
                  <div class="et-banner-vectors">
                     ...
                     <div class="absolute bottom-[352px] left-[845px]"><img
                           src="<?= get_template_directory_uri(); ?>/assets/img/banner-vector.png" alt="vector"></div>
                     <div class="absolute top-[214px] right-[190px]"><img
                           src="<?= get_template_directory_uri(); ?>/assets/img/banner-vector-2.png" alt="vector"
   ...
   <section
      class="et-2-schedules bg-[#EEF4FF] bg-[url('assets/img/schedule-bg.png')] bg-cover bg-no-repeat bg-center relative py-[130px] xl:py-[80px] md:py-[60px] before:absolute before:inset-0 before:bg-[url('../assets/img/')]">
      <div
...
">
               <div
                  class="et-schedules-tab-navs bg-[#D0E1FF] px-[12px] py-[14px] flex flex-w gap-[16px] sm:gap-[12px] rounded-full">
                  <?php if ( have_rows( 'button_get' ) ) : ?>
                  <?php while ( have_rows( 'button_get' ) ) : the_row(); ?>
                  <a href="<?php the_sub_field( 'url' ); ?>"
                     class="et-btn border w-[180px] bg-etBlue text-white inline-flex items-center justify-center h-[45px] px-[22px] xxs:px-[16px] font-normal text-[17px] rounded-full hover:!bg-etBlack hover:!text-white"><?php the_sub_field( 'title' ); ?></a>
                  <?php endwhile; ?>
                  <?php endif; ?>
         ...
         <div class="et-schedules-tab-container">
            <div id="tab1" class="et-tab active sm:hidden">
               <div class="all-scheduled-events flex flex-col gap-[30px]">
                ...
                ?>
                  <div
                     class="et-2-schedule bg-white mt-[57px] p-[12px] pt-0 rounded-[20px] inline-flex md:flex-col w-full gap-y-[20px] justify-between relative z-[2] rev-slide-up">
                     <!-- img -->
                     <div class="w-[240px] shrink-0 relative">
                        <div
                           class="et-2-schedule-img absolute md:static md:-mt-[45px] bottom-0 md:before:content-none before:absolute before:top-0 before:left-[100%] before:w-full before:h-full before:bg-gradient-to-br before:from-etBlue before:to-[#0B3998] before:-z-[1]">
                           <a href="<?= get_field('image_thumbnail', $post->ID) ?>" data-fslightbox="gallery">
                              <img style="height: 230px; width: 230px;"
                                 src="<?= get_field('image_thumbnail', $post->ID) ?>" alt="scehduled-event-cover"
                                 class="rounded-[20px] rounded-tr-none object-cover aspect-[8/9]">
                           </a>
                        </div>
                     </div>
                     ...
                     <!-- text -->
                     <div
                        class="px-[30px] sm:px-[12px] py-[25px] sm:pb-[15px] pt-[37px] md:pt-0 w-full flex xs:flex-col gap-y-[15px] items-center bg-white">
                        <!-- single schedule heading -->
                        <div class="pr-[46px] sm:pr-0 mr-[54px] sm:mr-0 border-r sm:border-r-0 border-[#d9d9d9]"
                           style="min-width: 71%;">
                           <!-- date & time -->
                           <div
                              class="et-schedule-date-time border border-[rgba(217,217,217,0.89)] xxs:border-0 py-[7px] px-[15px] xxs:p-0 rounded-full inline-flex xxs:w-full items-center justify-center gap-x-[24px] gap-y-[10px] mb-[10px]">
                              <div class="date flex items-center gap-[10px]">
                                 ...
                                 <span
                                    class="text-etGray font-normal text-[16px]"><?= get_field('date', $post->ID) ?></span>
                              </div>
                              ...
                              <div class="time flex items-center gap-[10px] xxs:hidden">
                                 ...
                                 <span
                                    class="text-etGray font-normal text-[16px]"><?= get_field('time', $post->ID) ?></span>
                              </div>
                           </div>

                           <!-- title -->
                           <h3
                              class="et-schedule-title text-[24px] sm:text-[22px] font-regular text-etBlack mb-[16px] anim-text">
                        ...
                        <div
                           class="flex shrink-0 xxl:flex-col xs:flex-row flex-wrap items-center xxl:items-start xs:items-center gap-x-[54px] gap-y-[16px]">
                           ...
                           <div class="flex shrink-0 flex-col xxs:flex-row gap-[16px] xxs:gap-[10px]">
                              ...
                              <a href="<?= $link_reservation ?>"
                                 class="et-btn border w-[180px] bg-etBlue text-white inline-flex items-center justify-center h-[45px] px-[22px] xxs:px-[16px] font-normal text-[17px] rounded-full hover:!bg-etBlack hover:!text-white">Book
                                 Your Seat</a>
                              <?php else :?>
      ...
      <!-- vectors -->
      <div class="md:hidden">
         <img src="<?= get_template_directory_uri(); ?>/assets/img/features-vector-1.png" alt="vector"
            class="pointer-events-none absolute top-[254px] left-[93px] -z-[1]">
         <img src="<?= get_template_directory_uri(); ?>/assets/img/schedule-vector.png" alt="vector"
            class="pointer-events-none absolute bottom-[270px] left-[125px] -z-[1]">
         <img src="<?= get_template_directory_uri(); ?>/assets/img/features-vector-2.png" alt="vector"
            class="pointer-events-none absolute top-[184px] right-[151px] -z-[1]">
         <img src="<?= get_template_directory_uri(); ?>/assets/img/features-vector-3.png" alt="vector"
            class="pointer-events-none absolute bottom-[455px] right-[93px] -z-[1]">
      </div>
   </section>
               ...
               <div>
                  <div class="et-member group">
                     <div class="et-member__img rounded-[16px] overflow-hidden">
                        <img src="<?php the_sub_field( 'image' ); ?>" alt="Team Member Image"
                           class="w-full duration-[400ms] group-hover:scale-110">
                     </div>

                     <div
                        class="et-member__txt bg-white relative z-[1] mx-[25px] md:mx-[15px] xs:mx-[5px] -mt-[44px] md:-mt-[15px] xs:mt-0 rounded-[16px] px-[25px] md:px-[15px] pb-[30px] md:pb-[20px] before:w-full before:absolute before:-z-[1] before:h-full before:bg-white before:left-0 before:rounded-[16px] before:-top-[33px] before:skew-y-[4deg]">
                        <div class="et-member-socials absolute right-[20px] -top-[43px]">
                           <div
                              ...
                              <a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_sub_field( 'link_share' ); ?>"
                              ...
                              <a href="javascript:void(0);" onclick="copyLink(<?php the_sub_field( 'link_share' ); ?>)"
                                 class="border border-white text-white w-[36px] h-[36px] flex items-center justify-center rounded-full hover:border-etBlue hover:bg-etBlue"><i
                        ...
                        <h5 class="font-semibold text-[16px] md:text-[20px] text-etBlack mb-[4px]"
                           style="padding: 12px 0px;"><a href="#"
                              class="hover:text-etBlue"><?php the_sub_field( 'name_speaker' ); ?></a></h5>
   ...
   <div
      ...
      <div
         class="box-cta-home bg-etBlue relative z-[1] p-[60px] xxl:p-[40px] xs:px-[20px] rounded-[20px] overflow-hidden -mb-[114px] shadow-[0_4px_50px_rgba(18,96,254,0.2)] after:absolute after:inset-0 after:-z-[1] after:bg-[url(../assets/img/et-counter-bg.jpg)] after:bg-cover after:bg-no-repeat after:mix-blend-screen">
         ...
         <div class="flex items-center justify-center md:flex-wrap gap-x-[140px] xxl:gap-x-[80px] gap-y-[20px]">
            <div class="flex gap-x-[62px] sm:flex-col gap-y-[15px]">
               <div class="flex items-center sm:justify-center gap-[15px] xxs:gap-[10px] shrink-0 ">
                  <!-- icon -->
                  <div
                     class="icon border border-white rounded-full w-[56px] aspect-square shrink-0 flex items-center justify-center">
                  ...
                  <div class="text-white">
                     ...
                     <h5 class="font-medium text-[22px] xxs:text-[22px]"><a
                           href="<?php the_sub_field( 'link_whatsapp' ); ?>"><?php the_sub_field( 'title_whatsapp' ); ?></a>
                     </h5>
                  </div>
               </div>
               <div
                  class="pl-[54px] overflow-hidden border-l-[4px] sm:border-l-0 border-white md:text-center md:pl-[15px] sm:pl-0 md:w-full relative before:absolute before:-left-[10px] before:top-[50%] before:-translate-y-[50%] before:w-[15px] before:aspect-square before:bg-white before:rotate-[45deg] before:-skew-x-[10deg] before:-skew-y-[10deg] sm:before:hidden">
                  <div
                     class="mb-[30px] text-[18px] font-light text-etGray md:mb-[30px] rev-slide-up text-white sm:text-[12px]"
            ...
            <a href="<?php the_sub_field( 'link_button' ); ?>"
               class="et-btn bg-white hover:!bg-etBlack hover:!text-white flex items-center justify-center gap-x-[15px] h-[50px] px-[15px] text-etBlue font-medium text-[17px] rounded-full shrink-0 group">
               <span class="icon">
         ...
         <!-- vectors -->
         <div>
            <img src="<?= get_template_directory_uri(); ?>/assets/img/cta-vector-1.png" alt="vector"
               class="pointer-events-none absolute top-0 left-0">
            <img src="<?= get_template_directory_uri(); ?>/assets/img/cta-vector-2.png" alt="vector"
   ...
   <div
            ...
            <div
               ...
               <div class="et-2-feature-card rounded-[30px] overflow-hidden group relative">
                  <div class="et-2-feature-card-txt bg-white p-[30px]">
                     ...
                     <!-- text -->
                     <div>
                        <h5 class="font-medium text-[18px] text-etBlack mb-[8px]"><a href="#"
                  ...
                  <div
                     ...
                     style="background-color: #18377e;">0<?php echo $no ; ?></div>
               </div>
               <?php $no++; endwhile; ?>
               <?php endif; ?>
      ...
      <!-- vectors -->
      <div>
         <img src="<?= get_template_directory_uri(); ?>/assets/img/stats-vector-2.png" alt="vector"
   ...
   <section class="grid grid-cols-4 lg:grid-cols-3 sm:grid-cols-2">
      ...
      <div
         class="<?php if($no > 4){ echo 'sm:hidden';} ?> relative z-[1] group before:absolute before:inset-0 before:bg-etBlue/70 before:z-[0] before:opacity-0 before:transition before:duration-[400ms] hover:before:opacity-100">
         <img src="<?php echo esc_url( $gallery_image_url ); ?>" alt="gallery image">
         <a href="<?php echo esc_url( $gallery_image_url ); ?>" data-fslightbox="gallery-img"
   ...
   <section style="display: none;"
      class="et-2-sponsors bg-[#00239F] py-[130px] lg:py-[80px] md:py-[60px] relative z-[1] before:absolute before:inset-0 before:bg-[url('assets/img/sponsors-bg.jpg')] before:bg-cover before:bg-center before:bg-no-repeat before:-z-[1] before:opacity-30">
      <div
         ...
         <div
            ...
            <div><img src="<?= get_template_directory_uri(); ?>/assets/img/sponsor-1-light.png" alt="sponsor logo"
                  class="w-[80%] mx-auto"></div>
            <div><img src="<?= get_template_directory_uri(); ?>/assets/img/sponsor-2-light.png" alt="sponsor logo"
                  class="w-[80%] mx-auto"></div>
            <div><img src="<?= get_template_directory_uri(); ?>/assets/img/sponsor-3-light.png" alt="sponsor logo"
                  class="w-[80%] mx-auto"></div>
            <div><img src="<?= get_template_directory_uri(); ?>/assets/img/sponsor-4-light.png" alt="sponsor logo"
                  class="w-[80%] mx-auto"></div>
            <div><img src="<?= get_template_directory_uri(); ?>/assets/img/sponsor-5-light.png" alt="sponsor logo"
                  class="w-[80%] mx-auto"></div>
            <div><img src="<?= get_template_directory_uri(); ?>/assets/img/sponsor-6-light.png" alt="sponsor logo"
                  class="w-[80%] mx-auto"></div>
            <div><img src="<?= get_template_directory_uri(); ?>/assets/img/sponsor-7-light.png" alt="sponsor logo"
                  class="w-[80%] mx-auto"></div>
            <div><img src="<?= get_template_directory_uri(); ?>/assets/img/sponsor-8-light.png" alt="sponsor logo"
                  class="w-[80%] mx-auto"></div>
            <div><img src="<?= get_template_directory_uri(); ?>/assets/img/sponsor-9-light.png" alt="sponsor logo"
                  class="w-[80%] mx-auto"></div>
            <div><img src="<?= get_template_directory_uri(); ?>/assets/img/sponsor-2-light.png" alt="sponsor logo"
                  class="w-[80%] mx-auto"></div>
            <div><img src="<?= get_template_directory_uri(); ?>/assets/img/sponsor-10-light.png" alt="sponsor logo"
                  class="w-[80%] mx-auto"></div>
         </div>

         <div class="text-center">
            <a href="#"
               class="bg-etBlue inline-flex items-center justify-center gap-[10px] h-[56px] px-[24px] rounded-[10px] text-white text-[16px] hover:bg-etBlue">Become
               a Sponsor <span class="icon"><i class="fa-solid fa-arrow-right-long"></i></span></a>
         </div>
      </div>
   </section>
         ...
         <div class="et-2-blogs-slider swiper p-[30px] -m-[30px]">
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide group">
                  <div
                     class="et-blog bg-white relative group-[.swiper-slide-visible]:shadow-[0_4px_25px_rgba(0,0,0,0.06)]">
                     <div class="et-blog__img relative overflow-hidden z-[1]">
                        <img src="<?php the_post_thumbnail_url();?>" alt="category-icon"
                     ...
                     <div class="et-blog__txt bottom-0 z-[3] p-[30px] lg:p-[20px]">
                        <div class="et-blog__infos flex gap-x-[30px] mb-[13px]">
                           ...
                           <div class="et-blog-info flex items-center gap-x-[10px]">
                              <span class="icon"><img
                                    src="<?= get_template_directory_uri(); ?>/assets/img/calender-blue.svg"
                                    alt="icon"></span>
                              <span
                                 class="text font-normal text-[14px] text-etGray sm:text-[12px]"><?php echo get_the_date("d  M  Y");?></span>
                           </div>

                           <!-- single info -->
                           <div class="et-blog-info flex items-center gap-x-[10px]">
                              <span class="icon"><img
                                    src="<?= get_template_directory_uri(); ?>/assets/img/user-blue.svg"
                                    alt="icon"></span>
                              <span class="text font-normal text-[14px] text-etGray sm:text-[12px]">BPro
                                 Administrator</span>
                           </div>
                        </div>

                        <h4 class="et-blog__title text-[22px] lg:text-[20px] sm:text-[18px] font-medium leading-[1.4] mb-[19px]"
                           style="color: #18377e;"><?php the_title();?></h4>

                        <a href="<?php the_permalink();?>"
                           class="text-[16px]  text-etGray inline-flex items-center gap-[10px] hover:text-etBlue">Read
