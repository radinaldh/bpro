...
<iframe width="100%" height="900" src="https://www.youtube.com/embed/cxPAZ5Z-9yg?si=QWEOB9Jpek2s1Zvw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
<section class="et-about py-[130px] xl:py-[80px] md:py-[60px] overflow-hidden relative">
    <div class="container mx-auto max-w-[calc(100%-39.1vw)] xxxl:max-w-[calc(100%-350px)] xl:max-w-[calc(100%-170px)] px-[12px] lg:max-w-full">
        <div class="flex items-center md:flex-wrap gap-x-[60px] xxl:gap-x-[40px] lg:gap-x-[30px] gap-y-[40px] sm:gap-y-[40px] lg:justify-center">
            <!-- left -->
            <div class="et-about-img relative z-[1] md:w-auto shrink-0 max-w-full mr-[70px] md:mr-0 ml-[28px] xxxl:ml-[47px] md:ml-0 xs:w-[70%] xxs:w-full">
            ...
            <div class="et-about__txt">
                <div class="rev-slide-up">
                    ...
                    <div class="my-[30px]">
                        ...
                        <h2 class="mb-[24px] md:mb-[19px] anim-text sm:text-[24px] text-[25px]">BPro – Join Our Ministry</h2>
                        <p class="my-[10px] text-[15px] sm:text-[12px]" style="text-align: justify;">
                            ...
                            <b>Creative & Art</b> – Multimedia, Photo-Videographer, Design & Content Creator, Lighting<br>
