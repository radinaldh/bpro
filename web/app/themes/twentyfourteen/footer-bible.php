  ...
  <footer class="et-footer bg-etBlack relative z-[1] before:absolute before:-z-[1] before:inset-0 before:bg-[url('<?= get_template_directory_uri(); ?>/assets/img/footer-1-bg.jpg')] before:opacity-30 before:mix-blend-overlay text-white">
      <div class="container mx-auto max-w-[calc(100%-37.1vw)] xxxl:max-w-[calc(100%-350px)] xl:max-w-[calc(100%-170px)] px-[12px] lg:max-w-full">
          ...
          <div class="et-footer-top pt-[130px] xl:pt-[80px] pb-[60px]">
              <!-- contact infos -->
              <div class="bg-etBlue py-[35px] px-[40px] xl:px-[30px] rounded-[20px] mb-[60px] overflow-hidden relative z-[1] flex lg:flex-wrap justify-between lg:justify-center xs:justify-start items-center gap-[20px] before:absolute before:-z-[1] before:inset-0 before:bg-[url('<?= get_template_directory_uri(); ?>/assets/img/contact-info-bg.jpg')] before:bg-cover before:bg-no-repeat before:bg-center before:opacity-40 before:mix-blend-multiply">
                  <!-- single info -->
              ...
              <div class="flex md:flex-wrap xs:w-full gap-x-[65px] xxl:gap-x-[45px] xl:gap-[30px] gap-y-[25px] justify-between md:justify-center xxs:justify-start">
                  ...
                  <div class="et-footer-about max-w-[295px] lg:max-w-none md:max-w-[300px] xs:max-w-full">
                      <a href="#" class="mb-[25px] inline-block"><img src="<?= get_template_directory_uri(); ?>/assets/img/logo-white.png" alt="logo" style="width: 90px !important;" style="width: 65% !important;"></a>
                      ...
                      <div class="space-y-[30px]">
                          ...
                          <div class="flex items-center gap-x-[30px] xxs:gap-x-[15px]">
                              <div class="rounded-[15px] overflow-hidden shrink-0">
                                  <img src="<?= get_template_directory_uri(); ?>/assets/img/cta-bg-2.jpg" alt="Event Image" class="w-[80px] aspect-square">
                              </div>
                          ...
                          <div class="flex items-center gap-x-[30px] xxs:gap-x-[15px]">
                              <div class="rounded-[15px] overflow-hidden shrink-0">
                                  <img src="<?= get_template_directory_uri(); ?>/assets/img/evenet-sched-2.jpg" alt="Event Image" class="w-[80px] aspect-square">
                              </div>
  ...
  <script src="<?= get_template_directory_uri(); ?>/assets/vendor/splide/splide.min.js"></script>
  <script src="<?= get_template_directory_uri(); ?>/assets/vendor/slim-select/slimselect.min.js"></script>
  <script src="<?= get_template_directory_uri(); ?>/assets/vendor/fslightbox/fslightbox.js"></script>
  <script src="<?= get_template_directory_uri(); ?>/assets/vendor/splide/splide-extension-auto-scroll.min.js"></script>
  <script src="<?= get_template_directory_uri(); ?>/assets/vendor/lenis/lenis.min.js"></script>
  <script src="<?= get_template_directory_uri(); ?>/assets/vendor/splittype/index.min.js"></script>
  <script src="<?= get_template_directory_uri(); ?>/assets/vendor/gsap/gsap.min.js"></script>
  <script src="<?= get_template_directory_uri(); ?>/assets/vendor/gsap/gsap-scroll-trigger.min.js"></script>


  <script src="<?= get_template_directory_uri(); ?>/assets/js/main.js"></script>
  <script src="<?= get_template_directory_uri(); ?>/assets/js/countdown.js"></script>
  </body>
