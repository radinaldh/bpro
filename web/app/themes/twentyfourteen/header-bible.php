...
<head>
    ...
    <style>
        ...
        header.et-header.to-be-fixed.py-\[30px\].fixed.top-0.w-full.px-\[155px\].xxxl\:px-\[100px\].xxl\:px-\[40px\].xs\:px-\[20px\].z-50.md\:mw100-\[200px\].sm\:mw100-\[200px\].xs\:mw100-\[200px\].xxs\:mw100-\[200px\] {
            padding-top: 15px;
            padding-bottom: 15px;
        }
    </style>
...
<body>
    ...
    <header class="et-header to-be-fixed py-[30px] xxs:py-[20px] fixed top-0 w-full px-[155px] xxxl:px-[100px] xxl:px-[40px] xs:px-[20px] z-50 md:mw100-[200px] sm:mw100-[200px] xs:mw100-[200px] xxs:mw100-[200px]" style="background: #18377e !important;">
